...
use color::Color;
use encoding::{
    ChannelDecoder, ChannelEncoder, ColorEncoding, EncodableColor, EncodedColor, LinearColor,
    LinearEncoding,
};
use linalg::Matrix3;
use num;
